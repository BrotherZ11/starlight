      ...
      >
        ...
        <nav className="navbar navbar-expand-lg">
          <div className="align-items-start">
            <FAQ
              FAQname={"¿CÓMO PUEDO REGISTRARME?"}
              FAQdescription={
                "Para registrarse primero pulse el botón 'registrarse' en la esquina superior derecha de la pantalla" +
            ...
            />
            <FAQ
              FAQname={"¿CÓMO PUEDO INICIAR SESIÓN?"}
              FAQdescription={
                "Para iniciar sesión primero pulse el botón 'iniciar sesión' en la esquina superior derecha de la pantalla, " +
            ...
            />
            <FAQ
              FAQname={"¿CÓMO PUEDO INGRESAR DINERO?"}
              FAQdescription={
                "Para ingresar dinero primero deberá iniciar sesión en la web. Después deberá dirigirse a la tienda " +
            ...
            />
            <FAQ
              FAQname={"¿PUEDO REMBOLSAR MI DINERO?"}
              FAQdescription={
                "Sí, en cualquier momento puede retirar su dinero, siempre teniendo en cuenta" +
            ...
            <FAQ
              FAQname={
                "¿CUÁNTO TARDARÉ EN VER REFLEJADO EL DINERO EN MI CUENTA?"
              }
              FAQdescription={
                "Lo normal es que lo vea reflejado de manera instantánea en su cuenta, pero dependiendo " +
                "de la entidad bancaria con la que haga el ingreso, puede tardar hasta 24 horas en verse reflejado en su cuenta." +
                " Si excede este tiempo le recomendamos hablar con su banco para ver el estado de la transacción"
              }
              FAQindex={5}
            />
            <FAQ
              FAQname={"¿COMO PUEDO JUGAR A LA RULETA?"}
              FAQdescription={
            ...
            />
            <FAQ
              FAQname={"¿COMO PUEDO JUGAR A LAS TRAGAPERRAS?"}
              FAQdescription={
